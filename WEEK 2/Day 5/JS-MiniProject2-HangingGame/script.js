function hangingGame() {
    ...
    console.log(wordStars);
        ...
        while(remainingLife > 0){
            ...
            } else if (wrongLetters.includes(letterGuess)==true || wordStars.includes(letterGuess)==true){ 
                console.log("You have already chosen this letter " +"You have "+try10+" Lives")
                findTrue==false;
            } else if (firstPlayer.includes(letterGuess)==false && wordStars.includes(letterGuess)==false){
                try10 =try10-1;
                findTrue==false;
